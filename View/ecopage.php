                    ...
                    <div class="col-lg-8 col-md-10 col-sm-9">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="ecopage.php" class="active">Economie</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12 col-md-offset-1">
					<div class="tm-what-we-do-right">
						 ...
						 <?php
                            include('../Controller/maineco.php');
                            $feedlist = new maineco('http://www.lemonde.fr/economie/rss_full.xml');
