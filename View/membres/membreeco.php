                    ...
                    <div class="col-lg-8 col-md-10 col-sm-9">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="membreeco.php?id_m=<?php echo $_SESSION['id_m']; ?>" class="active">Economie</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12 col-md-offset-1">
					<div class="tm-what-we-do-right">
						 ...
						 <?php
                            include('../../Controller/membre/eco_class.php');
                            $feedlist = new eco_class('http://www.lemonde.fr/economie/rss_full.xml');
