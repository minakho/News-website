                    ...
                    <div class="col-lg-8 col-md-10 col-sm-12">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="membretech.php?id_m=<?php echo $_SESSION['id_m']; ?>"class="active">Technologies</a></li>
                            </ul>
                        </nav>		
                    </div>				
                </div>
			...
			<div class="row">
				...
				<div class="col-md-12 col-md-offset-1">
					<div class="tm-what-we-do-right">
						 ...
						 <?php
                            include('../../Controller/membre/tech_class.php');
                            $feedlist = new tech_class('http://www.lemonde.fr/technologies/rss_full.xml');
