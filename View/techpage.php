                    ...
                    <div class="col-lg-8 col-md-10 col-sm-9">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="polpage.php" >Politiques</a></li>
                                <li><a href="techpage.php" class="active">Technologies</a></li>
                            </ul>
                        </nav>		
                    </div>				
                </div>
			...
			<div class="row">
				...
				<div class="col-md-12 col-md-offset-1">
					<div class="tm-what-we-do-right">
						 ...
						 <?php
                            include('../Controller/maintech.php');
                            $feedlist = new maintech('http://www.lemonde.fr/technologies/rss_full.xml');
